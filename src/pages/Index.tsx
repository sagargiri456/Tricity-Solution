...
const Index = () => {
  ...
  const services = [
    {
      ...
      icon: "🔧",
      description:
        "Professional plumbing solutions for homes and businesses with 24/7 emergency support.",
      services: [
    ...
    },
    {
      ...
      icon: "🎨",
      description:
        "Transform your spaces with our expert interior and exterior painting services.",
      services: [
        "Interior Painting",
        "Exterior Painting",
        "Texture Work",
    ...
    },
    {
      ...
      icon: "🛡️",
      description:
        "Protect your property from water damage with our advanced waterproofing solutions.",
      services: [
        "Roof Waterproofing",
    ...
    },
    {
      ...
      icon: "🪚",
      description:
        "Custom woodwork and furniture solutions crafted by skilled carpenters.",
      services: [
        "Custom Furniture",
        "Kitchen Cabinets",
        "Wardrobe Design",
    ...
    },
    {
      ...
      icon: "📐",
      description:
        "Professional architectural design and consultation services for your dream projects.",
      services: [
        "Design Planning",
        "3D Visualization",
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment:
        "Excellent plumbing work! They fixed our water heater issue quickly and professionally. Highly recommended for anyone in Chandigarh.",
    },
    {
      name: "Priya Sharma",
      ...
      rating: 5,
      comment:
        "The painting team did an amazing job on our home interior. Very clean work and completed on time. Great value for money.",
    },
    {
      name: "Amit Singh",
      location: "Mohali",
      rating: 5,
      comment:
        "Professional waterproofing service for our terrace. No more water leakage issues. The team was knowledgeable and efficient.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Navigation */}
      <nav
        className={`fixed top-0 w-full bg-white/10 dark:bg-neutral-900/20 backdrop-blur-lg border-b border-white/20 dark:border-white/10 z-50 shadow-md transition-all duration-300 ${
        ...
        <div className="container mx-auto px-4 h-20 md:h-20 flex items-center justify-between relative">
          ...
          <div className="hidden md:flex space-x-1 absolute left-1/2 -translate-x-1/2">
            {[
              ...
              >
                <span className="relative z-10 text-foreground font-semibold transition-colors duration-200">
                  {item.label}
                </span>
          ...
          <div className="md:hidden flex items-center space-x-2">
            <Button onClick={() => handleBookNow()} size="sm" className="bg-primary hover:bg-primary/90 text-xs px-3 py-1">
              Book Now
            </Button>
            <Button
              variant="ghost"
      ...
      <section id="testimonials" className="py-12 md:py-16 bg-background scroll-mt-24">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-4">What Our Clients Say</h2>
            <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {testimonials.map((testimonial, index) => (
              <TestimonialCard key={index} name={testimonial.name} location={testimonial.location} rating={testimonial.rating} comment={testimonial.comment} />
            ))}
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="py-12 md:py-20 relative overflow-hidden bg-accent scroll-mt-24">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-8 md:mb-16">
            ...
            <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto mt-4 md:mt-6">Ready to get started? Contact us today for a free consultation and quote.</p>
          </div>
